        ...
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                topBar(isss: 'About Us',
                img: 'Image/white.png'),
                SizedBox(
                  height: 30,
                ),
               logoline(taxt: 'is an innovative posture monitoring',),
               Text(" solution designed to help users improve their sitting habits and reduce back pain caused by poor posture.Combining a compact wearable device with a smart mobile application,",style: GoogleFonts.poppins(
                           fontSize: 13,color: const Color.fromARGB(255, 7, 7, 7)),),
               logoline(taxt: "tracks your posture in real time and provides",),
               Text(" gentle feedback whenever slouching is detected.Whether you're working from home, studying, or spending long hours at your desk, our app encourages healthier posture through awareness and habit-building not just temporary correction.This app was developed as part of an academic project, blending hardware design and modern mobile development to address one of the most common issues in today's sedentary lifestyle.",style: GoogleFonts.poppins(
              fontSize: 13,color: const Color.fromARGB(255, 19, 19, 19)),),
              SizedBox(height: 30,),
              Text('Have questions, feedback, or need help?',style: GoogleFonts.poppins(
            fontSize: 13,color: const Color.fromARGB(255, 19, 19, 19)),),
            Text("We'd love to hear from you!",style: GoogleFonts.poppins(
            fontSize: 13,color: const Color.fromARGB(255, 19, 19, 19)),),
            SizedBox(height: 10,),
            Row(children: [
...
class logoline extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    mainAxisAlignment: MainAxisAlignment.start,
       children: [
         Text('Sit',style: GoogleFonts.poppins(fontWeight: FontWeight.bold,
            fontSize: 15,color: const Color.fromARGB(255, 0, 0, 0))),
         Text('90', style: GoogleFonts.poppins(fontWeight: FontWeight.bold,
            fontSize: 15,color: Colors.lightBlueAccent)),
         Text(taxt, style: GoogleFonts.poppins(
            fontSize: 13,color: const Color.fromARGB(255, 19, 19, 19)),)
       ],
     );
  }
